...
class EchoBot(Client):
    def onMessage(self, author_id, message_object, thread_id, thread_type, **kwargs):
        ...
        try:
            message = str(message_object).lower()
            print(message.lower())


            #
            # if "klon" in message.lower() or "kitchen lights on" in message.lower:
            #     db.child("device1").set("on")
            # if "kloff" in message.lower() or "kitchen room lights off" in message.lower:
            #     db.child("device1").set("off")
            #
            # if "lron" in message.lower() or "living room lights on" in message.lower:
            #     db.child("device2").set("on")
            # if "lroff" in message.lower() or "living room lights off" in message.lower:
            #     db.child("device2").set("off")
            #
            #
            # #all lights off

            if "lights" in message.lower() and "on" in message.lower():
                print("On")
                db.child("device1").set("on")
                db.child("device2").set("on")
            if "lon" in message.lower():
                print("On")
                db.child("device1").set("on")
                db.child("device2").set("on")
            if "loff" in message.lower():
                print("off")
                db.child("device1").set("off")
                db.child("device2").set("off")
            if "lights" in message.lower() and "off" in message.lower():
                print("Off")
                db.child("device1").set("off")
                db.child("device2").set("off")

            if "koff" in message.lower():
                db.child("device1").set("off")
            if "lroff" in message.lower():
                db.child("device2").set("off")
            if "kon" in message.lower():
                db.child("device1").set("on")
            if "lron" in message.lower():
                db.child("device2").set("on")


            if "help" in message.lower():
                print("To turn lights off: 'loff' or 'lights off'")
                print("To turn lights off: 'lon' or 'lights on")
        except:
            pass
        #
